            ...
            <form action="/posts" method="POST">
              ...
              <div class="layui-row layui-col-space15 layui-form-item">
                ...
                <div class="layui-col-md9">
                  ...
                  <div class="layui-input-block">
                    <input type="text" id="L_title" name="title" required lay-verify="required" autocomplete="off" class="layui-input" value="{{ old('title') }}">
              ...
              <div class="layui-form-item layui-form-text">
                {{--  <div class="layui-input-block">
                  <textarea id="L_content" name="content" required lay-verify="required" placeholder="详细描述" class="layui-textarea fly-editor" style="height: 260px;">{{old("content")}}</textarea>
                </div>  --}}
                <div class="editor">
