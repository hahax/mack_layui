                    ...
                    <form method="post" action="/user/dosetting">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" id="L_email" name="email" required lay-verify="email" autocomplete="off" class="layui-input" value="{{$user->email}}">
                            </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-inline">
                                <div class="layui-input-inline">
                                    <input type="radio" name="sex" value="0" @if($user->gender == 0) checked @endif title="男">
                                    <input type="radio" name="sex" value="1" @if($user->gender == 1) checked @endif title="女">
                                </div>
                            </div>
                        </div>
                        <div class="layui-form-item">
                        ...
                        <div class="layui-form-item">
                            <button class="layui-btn" lay-filter="*" type="submit">确认修改</button>
                        </div>
                    </form>
                </div>

                <div class="layui-form layui-form-pane layui-tab-item">
                    <form method="post" action="/user/{{\Auth::id()}}/dosetting">
                        <div class="layui-form-item">
