...
layui.define(['layer', 'laytpl', 'form', 'element', 'upload', 'util'], function(exports) {
                    ...
                    picture: function(editor) { //插入图片
                        layer.open({
                            ...
                            content: ['<ul class="layui-form layui-form-pane" style="margin: 20px;">', '<li class="layui-form-item">',
                                ...
                                '</div>', '<button type="button" class="layui-btn layui-btn-primary" id="uploadImg"><i class="layui-icon">&#xe67c;</i>上传图片</button>',
    ...
    , elemSigninHelp = $('#LAY_signinHelp'), elemSigninTop = $('#LAY_signinTop'), elemSigninMain = $('.fly-signin-main'), elemSigninDays = $('.fly-signin-days');
